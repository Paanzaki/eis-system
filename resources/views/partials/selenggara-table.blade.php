                ...
                <tr>
                    ...
                    <td class="pr-10">
                        <div class="flex items-center justify-end gap-2">
                            <button class="p-1.5 rounded-lg bg-amber-50 hover:bg-amber-100 text-amber-600 transition-all">
                            ...
                            <button class="p-1.5 rounded-lg bg-red-50 hover:bg-red-100 text-red-500 transition-all">
