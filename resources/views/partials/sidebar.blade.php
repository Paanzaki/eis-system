<aside 
    ...
    <nav class="flex-1 px-3 space-y-1.5 py-6 overflow-y-auto custom-scrollbar">
        ...
        <div class="space-y-1">
            <button @click="openMenu === 'perolehan' ? openMenu = null : openMenu = 'perolehan'" 
                ...
                <div class="flex items-center gap-4">
                    ...
                    <span x-show="sidebarOpen" class="text-[10px] font-bold uppercase tracking-widest" style="font-family: Arial !important;">Perolehan</span>
                </div>
            ...
            <div x-show="openMenu === 'perolehan' && sidebarOpen" x-collapse x-cloak class="pl-12 space-y-1">
                <a href="{{ route('perolehan.data') }}" class="block py-2 text-[9px] font-bold {{ request()->routeIs('perolehan.data') ? 'text-blue-600' : 'text-gray-400 hover:text-blue-600' }} uppercase tracking-widest" style="font-family: Arial !important;">Analitik & ETL</a>
                <a href="{{ route('perolehan.carian') }}" class="block py-2 text-[9px] font-bold {{ request()->routeIs('perolehan.carian') ? 'text-blue-600' : 'text-gray-400 hover:text-blue-600' }} uppercase tracking-widest" style="font-family: Arial !important;">Carian Rekod</a>
            </div>
        </div>
        ...
        <div class="space-y-1">
            <button @click="openMenu === 'aset' ? openMenu = null : openMenu = 'aset'" 
                ...
                <div class="flex items-center gap-4">
                    ...
                    <span x-show="sidebarOpen" class="text-[10px] font-bold uppercase tracking-widest" style="font-family: Arial !important;">Maklumat Aset</span>
                </div>
            ...
            <div x-show="openMenu === 'aset' && sidebarOpen" x-collapse x-cloak class="pl-12 space-y-1">
                <a href="{{ route('aset') }}" class="block py-2 text-[9px] font-bold {{ request()->routeIs('aset') ? 'text-blue-600' : 'text-gray-400 hover:text-blue-600' }} uppercase tracking-widest" style="font-family: Arial !important;">Daftar Harta</a>
                <a href="{{ route('aset.pemeriksaan') }}" class="block py-2 text-[9px] font-bold {{ request()->routeIs('aset.pemeriksaan') ? 'text-blue-600' : 'text-gray-400 hover:text-blue-600' }} uppercase tracking-widest" style="font-family: Arial !important;">Pemeriksaan</a>
                <a href="{{ route('aset.pelupusan') }}" class="block py-2 text-[9px] font-bold {{ request()->routeIs('aset.pelupusan') ? 'text-blue-600' : 'text-gray-400 hover:text-blue-600' }} uppercase tracking-widest" style="font-family: Arial !important;">Pelupusan</a>
            </div>
        </div>
        ...
        <div class="space-y-1">
            <button @click="openMenu === 'naziran' ? openMenu = null : openMenu = 'naziran'" 
                ...
                <div class="flex items-center gap-4">
                    ...
                    <span x-show="sidebarOpen" class="text-[10px] font-bold uppercase tracking-widest" style="font-family: Arial !important;">Modul Naziran</span>
                </div>
            ...
            <div x-show="openMenu === 'naziran' && sidebarOpen" x-collapse x-cloak class="pl-12 space-y-1">
                <a href="{{ route('naziran.perolehan') }}" class="block py-2 text-[9px] font-bold {{ request()->routeIs('naziran.perolehan') ? 'text-blue-600' : 'text-gray-400 hover:text-blue-600' }} uppercase tracking-widest" style="font-family: Arial !important;">Naziran Perolehan</a>
                <a href="{{ route('naziran.aset') }}" class="block py-2 text-[9px] font-bold {{ request()->routeIs('naziran.aset') ? 'text-blue-600' : 'text-gray-400 hover:text-blue-600' }} uppercase tracking-widest" style="font-family: Arial !important;">Naziran Aset</a>
            </div>
        </div>
        ...
        <a href="{{ route('chatbot') }}" class="flex items-center gap-4 px-4 py-3.5 rounded-xl transition-all {{ request()->routeIs('chatbot') ? 'bg-blue-50 text-[#1E3A8A] border-l-4 border-yellow-400' : 'text-gray-400 hover:bg-gray-50' }}">
            ...
            <span x-show="sidebarOpen" class="text-[10px] font-bold uppercase tracking-widest" style="font-family: Arial !important;">Chatbot AI</span>
        </a>
        ...
        <div class="space-y-1">
            <button @click="openMenu === 'admin' ? openMenu = null : openMenu = 'admin'" 
                ...
                <div class="flex items-center gap-4">
                    ...
                    <span x-show="sidebarOpen" class="text-[10px] font-bold uppercase tracking-widest" style="font-family: Arial !important;">Tetapan</span>
                </div>
            ...
            <div x-show="openMenu === 'admin' && sidebarOpen" x-collapse x-cloak class="pl-12 space-y-1">
                <a href="#" class="block py-2 text-[9px] font-bold text-gray-400 hover:text-blue-600 uppercase tracking-widest" style="font-family: Arial !important;">Pendaftaran Baru</a>
                <a href="#" class="block py-2 text-[9px] font-bold text-gray-400 hover:text-blue-600 uppercase tracking-widest" style="font-family: Arial !important;">Pelantikan Pegawai</a>
                <a href="#" class="block py-2 text-[9px] font-bold text-gray-400 hover:text-blue-600 uppercase tracking-widest" style="font-family: Arial !important;">Audit Logs</a>
            </div>
        </div>
        ...
        <div class="space-y-1">
            <button @click="openMenu === 'maint' ? openMenu = null : openMenu = 'maint'" 
                ...
                <div class="flex items-center gap-4">
                    ...
                    <span x-show="sidebarOpen" class="text-[10px] font-bold uppercase tracking-widest" style="font-family: Arial !important;">Penyelenggaraan</span>
                </div>
            ...
            <div x-show="openMenu === 'maint' && sidebarOpen" x-collapse x-cloak class="pl-12 space-y-1">
                <a href="#" class="block py-2 text-[9px] font-bold text-gray-400 hover:text-blue-600 uppercase tracking-widest" style="font-family: Arial !important;">Senggara Perolehan</a>
                <a href="{{ route('penyelenggaraan') }}" class="block py-2 text-[9px] font-bold {{ request()->routeIs('penyelenggaraan') ? 'text-blue-600' : 'text-gray-400 hover:text-blue-600' }} uppercase tracking-widest" style="font-family: Arial !important;">Senggara Aset</a>
            </div>
        </div>
    ...
    <div class="p-4 border-t border-gray-50 space-y-4 flex flex-col items-center flex-shrink-0">
        <a href="{{ route('profile.edit') }}" class="flex items-center justify-center p-2 bg-gray-50 rounded-xl border border-gray-100 hover:bg-white hover:shadow-md transition-all w-full" :class="sidebarOpen ? 'gap-4 px-4' : 'w-12 h-12 p-0'">
            <div class="w-9 h-9 rounded-lg bg-[#1E3A8A] text-white flex items-center justify-center text-[10px] font-bold flex-shrink-0 border border-white/20" style="font-family: Arial !important;">
                {{ substr(Auth::user()->name, 0, 2) }}
            </div>
            <div x-show="sidebarOpen" x-transition.opacity class="flex-1 min-w-0 text-left">
                <p class="text-[9px] font-bold text-gray-800 truncate uppercase leading-tight" style="font-family: Arial !important;">{{ Auth::user()->name }}</p>
                <p class="text-[7px] font-bold text-blue-500 uppercase tracking-tighter" style="font-family: Arial !important;">Executive PNS</p>
            </div>
        </a>
        ...
        <form method="POST" action="{{ route('logout') }}" class="w-full">
            ...
            <button type="submit" class="w-full flex items-center justify-center py-3 text-gray-400 hover:text-red-600 hover:bg-red-50 transition-all rounded-xl group" :class="sidebarOpen ? 'px-5 gap-5' : 'px-0'">
                ...
                <span x-show="sidebarOpen" x-transition.opacity class="text-[9px] font-bold uppercase tracking-[0.2em] whitespace-nowrap" style="font-family: Arial !important;">Log Keluar</span>
            </button>
        </form>
    </div>
</aside>