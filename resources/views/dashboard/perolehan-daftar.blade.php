...
<div class="content-fluid space-y-8 pb-12">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6 border-b border-gray-100 pb-10">
        <div>
            ...
            <h3 class="text-4xl font-black text-[#1E3A8A] tracking-tighter uppercase leading-none">
                Pendaftaran <span class="text-red-600">Aset Baru.</span>
            </h3>
            <p class="text-[12px] font-black text-slate-400 uppercase tracking-[0.4em] mt-3">FB-EIS-AS-PA &mdash; Kemasukan Data Perolehan & Penomboran Siri (KEW.PA-2/3)</p>
        </div>
    ...
    <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 relative overflow-hidden group">
        <div class="flex items-center gap-4 mb-8 pb-4 border-b border-gray-50">
            <h4 class="text-[12px] font-black text-[#1E3A8A] uppercase tracking-widest">Maklumat Terperinci Aset</h4>
        </div>
        ...
        <form action="#" class="grid grid-cols-12 gap-10">
            ...
            <div class="col-span-12 flex justify-end gap-4 pt-10 border-t border-gray-50">
                <button type="button" class="px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest text-slate-400 hover:bg-gray-50 transition-all">
                    Draft Simpan
                </button>
                <button type="submit" class="bg-[#1E3A8A] hover:bg-red-700 text-white px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg transition-all">
                    Daftar & Jana No. Siri
                </button>
            </div>
        </form>
    ...
    <div class="bg-blue-50/50 p-6 rounded-2xl border border-blue-100 flex items-center gap-4">
        <div class="w-10 h-10 bg-white rounded-xl shadow-sm flex items-center justify-center text-blue-600 flex-shrink-0">
