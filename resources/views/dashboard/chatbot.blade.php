...
<div class="content-fluid space-y-8 pb-12">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6 border-b border-gray-100 pb-10">
        ...
        <div class="flex items-center gap-3 px-6 py-3 bg-white border border-gray-100 rounded-[5px] shadow-sm">
    ...
    <div class="bg-white rounded-[5px] shadow-2xl shadow-slate-200/60 flex flex-col border border-gray-100 overflow-hidden">
        ...
        <div class="chat-container p-10 overflow-y-auto space-y-10 custom-scrollbar">
            ...
            <div class="flex items-end gap-4">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <div class="bubble bot-style">
                        Selamat sejahtera, {{ explode(' ', Auth::user()->name)[0] }}. Saya adalah **FAI**, asisten analitik anda. <br><br>
            ...
            <div class="flex items-end flex-row-reverse gap-4">
                ...
                <div class="flex flex-col gap-1.5 items-end">
                    <span class="text-[8px] font-black text-slate-400 uppercase tracking-[0.2em] mr-1 ">{{ Auth::user()->name }}</span>
        ...
        <div class="p-8 bg-white border-t border-gray-100/50">
            <div class="flex items-center gap-5 max-w-5xl mx-auto">
                <div class="relative flex-1 group">
                    <input type="text" placeholder="Tanya FAI tentang data, aset atau naziran..." 
                        class="w-full bg-slate-50 border border-slate-100 py-5 px-8 rounded-[5px] text-xs font-bold outline-none focus:ring-4 focus:ring-blue-50 focus:border-blue-200 focus:bg-white transition-all shadow-inner">
                ...
                <button class="bg-[#1E3A8A] hover:bg-red-600 text-white w-16 h-16 rounded-[5px] flex items-center justify-center shadow-xl shadow-blue-900/20 transition-all hover:scale-105 active:scale-95 group">
            ...
            <div class="mt-5 flex flex-wrap gap-2 max-w-5xl mx-auto">
                ...
                <button class="px-4 py-2 bg-gray-50 hover:bg-yellow-50 border border-gray-100 rounded-[5px] text-[9px] font-black uppercase text-slate-400 hover:text-yellow-600 transition-all ">
                    # {{ $tag }}
                </button>
                @endforeach
            </div>
