    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-[5px] border border-gray-100 shadow-sm p-8">
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-start gap-4 p-4 bg-gray-50/50 rounded-[5px] hover:bg-white border border-transparent hover:border-gray-100 transition-all">
