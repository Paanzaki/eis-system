    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2 space-y-4">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('selenggara.faq') }}" class="flex items-center gap-2 px-4 py-2 bg-slate-50 border border-slate-200 rounded-[5px] text-[9px] font-black uppercase text-slate-500 hover:text-[#1E3A8A] hover:border-[#1E3A8A] transition-all">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-[5px] border border-gray-100 shadow-sm p-8 space-y-6">
                @foreach([
                ...
                <div class="flex items-center gap-4">
                    <div class="w-10 h-10 rounded-[5px] bg-[#1E3A8A]/5 flex items-center justify-center flex-shrink-0">
            ...
            <div class="bg-[#1E3A8A] rounded-[5px] p-8 text-white">
                ...
                <button class="w-full bg-white/10 hover:bg-white/20 text-white py-3 rounded-[5px] text-[10px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2">
