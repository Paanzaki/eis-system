...
<div class="flex h-[calc(100vh-180px)] rounded-[5px] overflow-hidden border border-gray-800 shadow-2xl">
    ...
    <div class="log-sidebar flex flex-col">
        <div class="p-6 border-b border-gray-800">
            ...
            <select class="w-full bg-[#1e293b] border border-gray-700 text-[10px] text-gray-300 p-2 rounded-[5px] outline-none">
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-2 space-y-1">
            ...
            <div class="file-item px-4 py-3 rounded-[5px] cursor-pointer group">
            ...
            <div class="file-item px-4 py-3 rounded-[5px] cursor-pointer group {{ $index == 0 ? 'active' : '' }}">
                <div class="flex justify-between items-center">
    ...
    <div class="flex-1 flex flex-col log-content">
        <div class="h-14 border-b border-gray-800 flex items-center justify-between px-8 bg-[#111827]">
            <div class="flex items-center gap-4">
                ...
                <span class="px-2 py-0.5 bg-blue-500/10 text-blue-400 text-[8px] rounded-[5px] font-bold">STABLE</span>
            </div>
            <div class="flex items-center gap-4">
                <input type="text" placeholder="Search logs..." class="bg-black/20 border border-gray-700 rounded-[5px] px-4 py-1.5 text-[10px] text-gray-400 outline-none w-64 focus:border-blue-500">
...
<div class="mt-6 flex items-center gap-4 p-4 bg-slate-900 rounded-[5px] border border-gray-800">
    <div class="p-2 bg-blue-500/10 rounded-[5px]">
    ...
    <p class="text-[10px] font-bold text-gray-400 italic leading-relaxed uppercase tracking-widest">
        Peringatan: Log Viewer ini merekodkan setiap transaksi sistem secara masa nyata (real-time). Maklumat sensitif telah di-mask mengikut standard PDPA.
    </p>
</div>
@endsection
