...
<head>
    ...
    <style>
        ...
        body {
            ...
            /* Ditingkatkan supaya nampak lebih jelas */
            --tw-bg-opacity-2: 0.20;
            /* Kuning pun naikkan sikit untuk balance */
        }
...
<body class="min-h-screen flex items-center justify-center p-6 overflow-hidden bg-selangor">
    ...
    <button @click="darkMode = !darkMode; localStorage.setItem('theme', darkMode ? 'dark' : 'light')"
        ...
        <svg x-show="!darkMode" class="w-5 h-5 text-[#1E3A8A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="w-full max-w-[1200px] grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <div class="hidden lg:block space-y-10">
            <div class="space-y-6 text-left">
                <div class="flex items-center gap-5 mb-10">
                    ...
                    <img src="{{ asset('images/pns.png') }}" alt="PNS Logo" class="h-32 drop-shadow-2xl">
                    ...
                    <div>
                        ...
                        <p
                            class="text-sm font-bold text-[#1E3A8A] dark:text-white uppercase tracking-widest leading-tight">
                            Perbendaharaan Negeri<br>Selangor</p>
                    </div>
                </div>

                <h1
                    class="text-8xl font-extrabold text-[#1E3A8A] dark:text-white tracking-tighter leading-none italic uppercase">
                    PNS<span class="text-yellow-500">EIS.</span>
                </h1>
                <p
                    class="text-slate-500 dark:text-slate-400 text-xl font-medium tracking-tight leading-relaxed max-w-sm">
        ...
        <div class="glass-card rounded-sharp p-10 lg:p-14 w-full max-w-lg mx-auto relative overflow-hidden">
            <div class="mb-10 text-left">
                <h2 class="text-2xl font-extrabold text-[#1E3A8A] dark:text-white tracking-tighter uppercase">Log Masuk
                </h2>
            ...
            <div class="space-y-4">
                ...
                <button type="button"
                    ...
                    <div class="flex items-center gap-4 text-left">
                        <img src="{{ asset('images/mydid-logo.png') }}" alt="MyDigitalID"
                            class="h-8 grayscale group-hover:grayscale-0 transition-all">
                        <div>
                            <p
                                class="text-[9px] font-black uppercase text-slate-400 dark:text-slate-500 tracking-widest">
                                Akses Persekutuan</p>
                            <p class="text-[11px] font-black uppercase text-[#1E3A8A] dark:text-white tracking-widest">
                                MyDigitalID</p>
                        </div>
                    </div>
                    <svg class="w-5 h-5 text-slate-300 dark:text-slate-500 group-hover:text-yellow-500 transition-colors"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path d="M13 5l7 7-7 7M5 12h14" stroke-width="2" />
                    </svg>
                </button>
                ...
                <a href="{{ route('login') }}"
                    ...
                    <div class="flex items-center gap-4 text-left text-white">
                        <div class="w-8 h-8 rounded-[5px] bg-white/10 flex items-center justify-center">
                        ...
                        <div>
                            <p class="text-[9px] font-black uppercase text-white/50 tracking-widest">Akses
                                Perbendaharaan</p>
            ...
            <div
                class="mt-12 pt-8 border-t border-slate-100 dark:border-white/5 flex justify-between items-center text-[7px] font-black text-slate-400 dark:text-slate-600 uppercase tracking-widest ic">
