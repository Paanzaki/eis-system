<x-guest-layout>
    ...
    <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
        ...
        <div>
            ...
            <x-text-input id="email" class="block mt-1 w-full !bg-gray-50 !border-gray-200 focus:!border-[#FEB05D] focus:!ring-0 !rounded-[5px] !py-3 !font-bold !text-[#2C2C2C]" type="email" name="email" :value="old('email')" required autofocus />
